...
public partial class New : System.Web.UI.Page
{
    ...
    private void UpLoad(string fileName)
    {
        ...
        string uri = "ftp://" + ftpServerIP + "/tif/" + fileInf.Name;
        FtpWebRequest reqFTP;
        //根据url创建ftpWebRequest对象
        reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri("ftp://" + ftpServerIP + "/tif/" + fileInf.Name));
        //ftp用户名和密码
    ...
    //        uploading.Attributes["style"] = "display:'none'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
     ...
     //   this.Page.RegisterStartupScript("", "<script>alert('"+a+"')</script>");
      ...
      //  System.Threading.Thread thread = new System.Threading.Thread(new System.Threading.ThreadStart(UpLoad));
     //   thread.Start();   
    //    uploading.Attributes["style"] = "display:''";
     //  UpLoad(a);
     //  AddHandler handler = new AddHandler(UpLoad);
     //  IAsyncResult result = handler.BeginInvoke(a, Succeed, "AsycState:OK");
